  ...
  return (
    <main className="mt-10 mx-auto px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
      <div className="sm:text-center lg:text-left">
        <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl xs:text-4xl">
          <span className="block xl:inline whitespace-nowrap">
            {mainHero.title}{' '}
          </span>
          {<br />}
          <span
            className={`whitespace-nowrap text-4xl block text-primary sm:inline`}
          >
            {mainHero.subtitle}
          </span>
        </h1>
